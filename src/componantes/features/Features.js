...
import Image2 from "../../images/token-sale-shape (1).svg";
import moduleName from "./features.css";
const Features = () => {
    return (
        <div id="features" className="features pt-5 pb-5 mb-5">
            <img src={Image2} alt="" />
            <div className="container pt-5" data-aos="fade-up">
                <h3 className="text-center pt-5">CRYPTO FEATURE</h3>
                <h1 className="text-center header">Best Features</h1>
                <p className="text-center mx-auto mb-5 pb-5">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nunc sed congue arcu, In et dignissim quam condimentum vel.
                </p>
                <div className="feature row">
                    <div className="box text-center col-lg-4 col-md-6 col-sm-12">
                        <div className="back mx-auto mb-4">
                            <svg
                                width="40"
                                height="40"
                                viewBox="0 0 40 40"
                        ...
                        <p>
                            ...
                            eiusmod tempor labore labore labore et dolor .
                        </p>
                    </div>
                    <div className="box text-center  col-lg-4 col-md-6 col-sm-12">
                        <div className="back mx-auto mb-4">
                    ...
                    <div className="box text-center col-lg-4 col-md-6 col-sm-12">
                        <div className="back mx-auto mb-4">
                            ...
                            >
                                ...
                                ></path>
                                <path
                                    d="M5 22.5H18.3333V35.8333H5V22.5Z"
                                    fill="white"
                                ></path>
                            </svg>
                        </div>
