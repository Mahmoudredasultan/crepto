            ...
            <div className="container pt-5" data-aos="fade-up">
                <div className="cont mx-auto pt-5">
                    ...
                    <p>
                        ...
                        template crafted with Tailwind CSS. Comes with all
                        essential UI components and pages to launch complete
                        website or landing page for anything that related to
                        Crypto, Blockchain and Web3.
                    </p>
                    <div className="coins d-flex  align-items-center w-50 mx-auto mb-5 mt-5">
                        <div>
                            <svg
                                width="28"
                                height="29"
