...
const Post = ({ header, data, img, text }) => {
    return (
        <div className="post">
            <h1>{header}</h1>
            <div className="data d-flex align-items-center">
                <div className="data1 d-flex align-items-center">
                    <svg
                        fill="currentColor"
                        width="22"
                        height="22"
                ...
                <div className="data2 d-flex align-items-center ms-3">
                    <svg
                        width="21"
                        fill="currentColor"
                        height="21"
